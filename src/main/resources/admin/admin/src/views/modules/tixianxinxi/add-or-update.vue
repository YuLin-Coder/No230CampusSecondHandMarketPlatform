<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="提现编号" prop="tixianbianhao">
            <el-input v-model="ruleForm.tixianbianhao" 
                placeholder="提现编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tixianbianhao" label="提现编号" prop="tixianbianhao">
              <el-input v-model="ruleForm.tixianbianhao" 
                placeholder="提现编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="提现时间" prop="tixianshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.tixianshijian" 
                type="date"
                :readonly="ro.tixianshijian"
                placeholder="提现时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tixianshijian" label="提现时间" prop="tixianshijian">
              <el-input v-model="ruleForm.tixianshijian" 
                placeholder="提现时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.tixianshijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jine = true;
          ...
          if(o=='tixianshijian'){
            this.ruleForm.tixianshijian = obj[o];
	    this.ro.tixianshijian = true;
            continue;
          }
          if(o=='beizhu'){
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springbootz5q40/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
