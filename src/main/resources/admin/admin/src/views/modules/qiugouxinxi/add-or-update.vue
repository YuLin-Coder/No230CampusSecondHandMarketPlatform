<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="求购编号" prop="qiugoubianhao">
            <el-input v-model="ruleForm.qiugoubianhao" 
                placeholder="求购编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qiugoubianhao" label="求购编号" prop="qiugoubianhao">
              <el-input v-model="ruleForm.qiugoubianhao" 
                placeholder="求购编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="求购时间" prop="qiugoushijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qiugoushijian" label="求购时间" prop="qiugoushijian">
              <el-input v-model="ruleForm.qiugoushijian" 
                placeholder="求购时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="求购详情" prop="qiugouxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.qiugouxiangqing" label="求购详情" prop="qiugouxiangqing">
                    <span v-html="ruleForm.qiugouxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.qiugouxiangqing = this.ruleForm.qiugouxiangqing.replace(reg,'../../../springbootz5q40/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
