<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="评论编号" prop="pinglunbianhao">
            <el-input v-model="ruleForm.pinglunbianhao" 
                placeholder="评论编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pinglunbianhao" label="评论编号" prop="pinglunbianhao">
              <el-input v-model="ruleForm.pinglunbianhao" 
                placeholder="评论编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="评论时间" prop="pinglunshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.pinglunshijian" 
                type="date"
                :readonly="ro.pinglunshijian"
                placeholder="评论时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pinglunshijian" label="评论时间" prop="pinglunshijian">
              <el-input v-model="ruleForm.pinglunshijian" 
                placeholder="评论时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="评论内容" prop="pinglunneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.pinglunneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.pinglunneirong" label="评论内容" prop="pinglunneirong">
                    <span v-html="ruleForm.pinglunneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	pinglunbianhao : false,
	shangpinmingcheng : false,
	pinglunneirong : false,
	pinglunshijian : false,
  ...
  created() {
	this.ruleForm.pinglunshijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='pinglunbianhao'){
            this.ruleForm.pinglunbianhao = obj[o];
	    this.ro.pinglunbianhao = true;
            continue;
          }
	    ...
	    this.ro.shangpinmingcheng = true;
          ...
          if(o=='pinglunneirong'){
            this.ruleForm.pinglunneirong = obj[o];
	    this.ro.pinglunneirong = true;
            continue;
          }
          if(o=='pinglunshijian'){
            this.ruleForm.pinglunshijian = obj[o];
	    this.ro.pinglunshijian = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
	...
	this.ruleForm.pinglunneirong = this.ruleForm.pinglunneirong.replace(reg,'../../../springbootz5q40/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
